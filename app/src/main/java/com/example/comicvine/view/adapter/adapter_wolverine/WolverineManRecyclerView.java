package com.example.comicvine.view.adapter.adapter_wolverine;
...
public class WolverineManRecyclerView extends RecyclerView.Adapter<WolverineManRecyclerView.MyHolder> {

    List<IssuesResults> mList;
    Context context;

    public WolverineManRecyclerView(List<IssuesResults> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public WolverineManRecyclerView.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WolverineManRecyclerView.MyHolder holder, int position) {
