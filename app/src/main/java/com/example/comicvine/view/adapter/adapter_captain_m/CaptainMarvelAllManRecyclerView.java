package com.example.comicvine.view.adapter.adapter_captain_m;
...
public class CaptainMarvelAllManRecyclerView extends RecyclerView.Adapter<CaptainMarvelAllManRecyclerView.MyHolder> {

    List<IssuesResults> mList;
    Context context;

    public CaptainMarvelAllManRecyclerView(List<IssuesResults> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public CaptainMarvelAllManRecyclerView.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CaptainMarvelAllManRecyclerView.MyHolder holder, int position) {
