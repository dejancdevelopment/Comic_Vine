...
public class CaptainMarvelManRecyclerView extends RecyclerView.Adapter<CaptainMarvelManRecyclerView.MyHolder> {

    List<IssuesResults> mList;
    Context context;

    public CaptainMarvelManRecyclerView(List<IssuesResults> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public CaptainMarvelManRecyclerView.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CaptainMarvelManRecyclerView.MyHolder holder, int position) {
