package com.example.comicvine.view.adapter.adapter_avengers;
...
public class AvengersAllManRecyclerView extends RecyclerView.Adapter<AvengersAllManRecyclerView.MyHolder> {

    List<IssuesResults> mList;
    Context context;

    public AvengersAllManRecyclerView(List<IssuesResults> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public AvengersAllManRecyclerView.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AvengersAllManRecyclerView.MyHolder holder, int position) {
