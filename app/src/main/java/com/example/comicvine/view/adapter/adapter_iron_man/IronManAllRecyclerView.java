package com.example.comicvine.view.adapter.adapter_iron_man;
...
public class IronManAllRecyclerView extends RecyclerView.Adapter<IronManAllRecyclerView.MyHolder> {

    List<IssuesResults> mList;
    Context context;

    public IronManAllRecyclerView(List<IssuesResults> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public IronManAllRecyclerView.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull IronManAllRecyclerView.MyHolder holder, int position) {
